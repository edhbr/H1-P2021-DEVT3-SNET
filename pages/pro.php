...
<body>
  ...
  <main class="services row" data-equalizer>
    <h1 class="small-12 columns">Locaux Professionnels</h1>
    <div class="servicesSlider pro hide-for-small-only medium-5 columns" data-equalizer-watch></div>
    <div class="pDesc blue small-12 medium-7 columns" data-equalizer-watch>
      ...
      <div class="centerWrapper">
        <a href="pages/contact.php" class="blue">Obtenir un devis<img src="images/devis.png" alt="Icon file"></a>
      </div>
    </div>
  </main>
